package com.staticfinalkeyword.task;
...
public class MainWriteJson {
	...
	static {
		file = new File("AuthorInterface.json");
	}
...
//		File file = new File("AuthorInterface.json"); // Json file where all written output stored
		...
		AuthorOperationsImpl authorOperation = new AuthorOperationsImpl();
		authorOperation.doSaveAuthor(n, file, jsonList, authList);
